...
- El enchufe inteligente se agenda para que se prenda en los horarios que queramos. Por efecto de la configuración de pulsos solito se va a pagar. O si su enchufe no soporta esto, entonces agendar el apagado tambien.  
Sin cambios, Arduino estaría programado para 25s de apertura de valvula + 120s de riego + 25s de cerrado de valvula, Arduino toma entre 1-3s en iniciar el programa. Eso es un total de 2min 53s. Por lo que podemos agendar nuestro apagador inteligente para apagarse a los 3 minutos.  
